...
3. [ ] **Build credential and provider infrastructure.** Implement environment and authenticated-encryption credential resolvers, key-version rotation, redaction, the provider registry, and capability enforcement.
