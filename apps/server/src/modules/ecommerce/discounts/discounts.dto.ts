...
export const DiscountIdParamDto = t.Object({ id: t.String({ minLength: 1 }) });
...
export const CreateDiscountDto = t.Object({
  ...
  minimumOrderAmount: t.Optional(t.Union([t.String(), t.Number(), t.Null()])),
...
export const ValidateDiscountDto = t.Object({
  ...
  subtotalAmount: t.Union([t.String(), t.Number()]),
