export const Permissions = {
  ...
  AdminDeliveryRead: "admin.delivery.read",
  AdminDeliveryDispatch: "admin.delivery.dispatch",
  AdminDeliveryReturns: "admin.delivery.returns",
  AdminDeliveryReconcile: "admin.delivery.reconcile",
  AdminDeliverySettings: "admin.delivery.settings",
  AdminDiscountsRead: "admin.discounts.read",
